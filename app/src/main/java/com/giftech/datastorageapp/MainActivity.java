package com.giftech.datastorageapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String PREFNAME = "com.giftech.datastorageapp.PREF";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textBaca = findViewById(R.id.tv_baca);
        editText = findViewById(R.id.et_input_file);
    }
